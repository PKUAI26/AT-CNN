...
from stAdv import SpatialTransformedAttack
...
parser.add_argument('--epochs', default=19, type=int, metavar='N',
...
Attackmethod = SpatialTransformedAttack(criterion, pai = args.pai , sigma = args.sigma, nb_iters = args.iter)
...
while True:
    ...
    Trainresults = adversairal_train_one_epoch(net, optimizer, ds_train, criterion, Attackmethod, clock,
